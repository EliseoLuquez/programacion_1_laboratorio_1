...
void mostrarEmpleadoPorSector(eEmpleado empleado[], int tam, eSector sectores[], int tamSector)
{
    for(int i = 0; i < tam; i++)
    {
        if(empleado[i] == sectores[i])
        {

        }
    }
}
void empleado q mas gana por sector
void ordenar empleado por sector y nombre
