...
int menu()
{
    ...
    printf("                 |  8-  Listar Marcas                        |\n");
    printf("                 |  9-  Listar Juegos                        |\n");
    printf("                 | 10-  Listar Juegos Categorias             |\n");
    printf("                 | 11-  Listar Alquiler por Cliente          |\n");
    printf("                 | 12-  Listar Importe Total Alq por Cliente |\n");
    printf("                 | 13-  Listar Clientes Sin Alquilar         |\n");
    printf("                 | 14-  Listar Juegos Sin Alquilar           |\n");
    printf("                 | 15-  Listar Juegos por Marca              |\n");
    printf("                 | 20-  Salir                                |\n");
    printf("                 |___________________________________________|\n");
